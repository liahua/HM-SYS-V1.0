...
insert  into `customer_info`(`id`,`customer_name`,`gender`,`country`,`telephone`,`card_type`,`card_num`,`operator`,`createdTime`,`modifiedTime`) values (1,'李菲菲','女','中国','13036985274','身份证','4566887992545','54654','2018-12-27 09:02:38','2018-12-20 09:02:42'),(2,'刘帅帅','男','越南','17025689345','护照','54661646456','465464','2018-12-26 09:02:46','2018-12-20 09:02:50');
...
insert  into `order_info`(`id`,`room_id`,`customer_id`,`checkin_date`,`checkout_date`,`customer_type`,`order_stat_id`,`order_money`,`operator`,`createdTime`,`modifiedTime`) values (1,1,0,'2018-12-25 08:55:16','2018-12-28 08:55:45','1',1,200,'zha','2018-12-28 08:57:50','2018-12-29 08:57:54'),(2,2,0,'2018-12-04 08:55:30','2018-12-15 08:55:56','1',NULL,200,'的好方法','2018-12-20 08:57:58','2018-12-27 08:58:01');
...
insert  into `room_info`(`id`,`rt_id`,`room_name`,`room_add`,`bed_num`,`stat_id`) values (1,1,'1101','1楼',1,1),(2,2,'2202','2楼',1,2),(3,3,'3303','3楼',1,3);
...
insert  into `stay_info`(`id`,`order_id`,`room_id`,`customer_id`,`stay_date`,`stay_day_count`,`stay_man_count`,`cash`,`leave_date`,`is_checkout`,`operator`,`createdTime`,`modifiedTime`) values (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL);
