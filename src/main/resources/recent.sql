...
--
-- Host: localhost    Database: eylsys
-- ------------------------------------------------------
...
INSERT INTO `customer_info` VALUES (1,'李菲菲','女','中国','13036985274','身份证','4566887992545','54654','2018-12-27 09:02:38','2018-12-20 09:02:42'),(2,'刘帅帅','男','越南','17025689345','护照','54661646456','465464','2018-12-26 09:02:46','2018-12-20 09:02:50');
...
INSERT INTO `customer_type` VALUES (1,'散户',1),(2,'组团',0.9),(3,'政府',0.8);
...
--
-- Dumping data for table `july_price`
--

LOCK TABLES `july_price` WRITE;
/*!40000 ALTER TABLE `july_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `july_price` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `order_stat` WRITE;
/*!40000 ALTER TABLE `order_stat` DISABLE KEYS */;
INSERT INTO `order_stat` VALUES (1,'已预订'),(2,'已取消');
/*!40000 ALTER TABLE `order_stat` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `room_info` VALUES (1,1,'1101','1楼',1,1),(2,2,'2202','2楼',1,2),(3,3,'3303','3楼',1,3),(4,4,'1101','2',1,3);
...
--
-- Dumping data for table `room_stat`
--

LOCK TABLES `room_stat` WRITE;
/*!40000 ALTER TABLE `room_stat` DISABLE KEYS */;
INSERT INTO `room_stat` VALUES (1,'空闲',NULL,NULL),(2,'已入住',NULL,NULL),(3,'已预订',NULL,NULL);
/*!40000 ALTER TABLE `room_stat` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `room_type` VALUES (1,'高级大床房',1.1),(2,'豪华套房',1.5),(3,'总统套房',2),(4,'行政房',2.1),(5,'豪华双床房',10);
...
--
-- Dumping data for table `stay_info`
--

LOCK TABLES `stay_info` WRITE;
/*!40000 ALTER TABLE `stay_info` DISABLE KEYS */;
INSERT INTO `stay_info` VALUES (1,1,1,2,'2018-12-26 08:55:01',NULL,NULL,NULL,'2018-12-27 09:44:26',0,'',NULL,NULL),(2,2,2,1,'2018-12-04 08:55:30',NULL,NULL,NULL,'2018-12-15 08:55:56',0,NULL,NULL,NULL),(4,3,2,1,'2018-12-21 09:40:59',NULL,NULL,NULL,'2018-12-22 09:41:04',0,NULL,NULL,NULL);
/*!40000 ALTER TABLE `stay_info` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-12-21 10:04:20
